...
* Go into the project folder (*gatsby-site* in my case) and install the [GraphQL plugin for Gatsby](https://www.gatsbyjs.org/packages/gatsby-source-graphql/): `npm install --save gatsby-source-graphql`
